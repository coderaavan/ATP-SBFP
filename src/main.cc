...
//	ooo_cpu[i].L2C.translation_insertion = 7;
  ...
  cout << "Allocated PAGES: " << allocated_pages << endl;
  cout << "COLD MISS: " << cold_miss << endl;
  cout << "SBFP Access: "<< sbfp_access<<endl;
  cout << "SBFP PQ Hits: "<< sbfp_pq_hit<<endl;
  cout << "SBFP PQ Hit Rate: "<< ((double)sbfp_pq_hit / (double)sbfp_access) * 100 <<endl;
